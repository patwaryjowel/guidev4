                                        ...
                                        <div class="col-lg-6">
                                            <div class="card-body">
                                                ...
                                                <table class="table table-bordered  mt-5">
                                                    ...
                                                    <tr><td>Address / Intersection</td><td>{{$booking->address_one}}</td> </tr>
                                                    <tr><td>Google Map Link</td><td>{{$booking->map_link_one}}</td> </tr>

                                                    <tr><td>Airport Name</td><td>{{$booking->airport_two}}</td> </tr>
                                                    <tr><td>FLIGHT Number</td><td>{{$booking->flight_two}}</td> </tr>
                                                    <tr><td>ARRIVAL TIME</td><td>{{$booking->arrival_time_two}}</td> </tr>
